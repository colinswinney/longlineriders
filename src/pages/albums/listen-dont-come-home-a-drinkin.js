...
export default function Drinkin({...restProps}) {
    ...
    return (
        <main {...restProps}>
            ...
            <iframe title="Don't Come Home a Drinkin'" className="drinkin" src="https://bandcamp.com/EmbeddedPlayer/album=3949658819/size=large/bgcol=fffdfb/linkcol=0F7FA9/transparent=true/" seamless><a href="https://longlineriders.bandcamp.com/album/dont-come-home-a-drinkin">Don&#39;t Come Home A-Drinkin&#39; by Long Line Riders</a></iframe>
